...
ImageLoaderPlugin ImageLoader;

ImageLoaderPlugin& ImageLoaderPlugin::GetPlugin()
{
    return ImageLoader;
}
...
static class H3ImageLoaderInternal : public H3Plugin::ImageLoader::H3ImageLoader
{
