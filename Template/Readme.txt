By adding the "H3.Plugin.zip" Visual Studio project template to your Item Templates directory,
you will have a quick way to create your own plugins within the H3Plugin solution.
